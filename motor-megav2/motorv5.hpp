...
unsigned int16_t cot = 0; //一時回転数用変数
uint32_t no=0;
unsigned int dtemp;
...
long double ocr = 0;//OCR0A値
int16_t kasan = 0;//I制御用　誤差
int16_t best = 0;//オーバーフロー時の最適カウント数
int16_t nox=0;
...
uint16_t distance[7] = {0,2975,6500,1900,1000,0,0};//Max65535
